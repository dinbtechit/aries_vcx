...
class AgentPlatform extends FlutterRustBridgeBase<AgentWire> {
  AgentPlatform(ffi.DynamicLibrary dylib) : super(AgentWire(dylib));
...
class AgentWire implements FlutterRustBridgeWireBase {
  @internal
  ...
  AgentWire(ffi.DynamicLibrary dynamicLibrary)
      : _lookup = dynamicLibrary.lookup;

  /// The symbols are looked up with [lookup].
  AgentWire.fromLookup(
