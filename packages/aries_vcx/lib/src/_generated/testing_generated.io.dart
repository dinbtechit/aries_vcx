...
class TestingPlatform extends FlutterRustBridgeBase<TestingWire> {
  TestingPlatform(ffi.DynamicLibrary dylib) : super(TestingWire(dylib));
...
class TestingWire implements FlutterRustBridgeWireBase {
  @internal
  ...
  TestingWire(ffi.DynamicLibrary dynamicLibrary)
      : _lookup = dynamicLibrary.lookup;

  /// The symbols are looked up with [lookup].
  TestingWire.fromLookup(
  ...
  void wire_enable_mocks(
    int port_,
  ) {
    return _wire_enable_mocks(
      port_,
    );
  }

  late final _wire_enable_mocksPtr =
      _lookup<ffi.NativeFunction<ffi.Void Function(ffi.Int64)>>(
          'wire_enable_mocks');
  late final _wire_enable_mocks =
      _wire_enable_mocksPtr.asFunction<void Function(int)>();
