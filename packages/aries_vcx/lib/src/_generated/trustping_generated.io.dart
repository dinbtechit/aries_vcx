...
class TrustpingPlatform extends FlutterRustBridgeBase<TrustpingWire> {
  TrustpingPlatform(ffi.DynamicLibrary dylib) : super(TrustpingWire(dylib));
...
// Section: api2wire
  ...
  ffi.Pointer<wire_uint_8_list> api2wire_uint_8_list(Uint8List raw) {
    final ans = inner.new_uint_8_list_16(raw.length);
...
class TrustpingWire implements FlutterRustBridgeWireBase {
  @internal
  ...
  TrustpingWire(ffi.DynamicLibrary dynamicLibrary)
      : _lookup = dynamicLibrary.lookup;

  /// The symbols are looked up with [lookup].
  TrustpingWire.fromLookup(
  ...
  void wire_trustping_build_response_msg(
    int port_,
    ffi.Pointer<wire_uint_8_list> ping,
  ) {
    return _wire_trustping_build_response_msg(
      port_,
      ping,
    );
  }

  late final _wire_trustping_build_response_msgPtr = _lookup<
          ffi.NativeFunction<
              ffi.Void Function(ffi.Int64, ffi.Pointer<wire_uint_8_list>)>>(
      'wire_trustping_build_response_msg');
  late final _wire_trustping_build_response_msg =
      _wire_trustping_build_response_msgPtr
  ...
  void wire_trustping_build_ping(
    ...
    return _wire_trustping_build_ping(
      port_,
      request_response,
      comment,
    );
  ...
  late final _wire_trustping_build_pingPtr = _lookup<
      ffi.NativeFunction<
          ffi.Void Function(ffi.Int64, ffi.Bool,
              ffi.Pointer<wire_uint_8_list>)>>('wire_trustping_build_ping');
  late final _wire_trustping_build_ping = _wire_trustping_build_pingPtr
      .asFunction<void Function(int, bool, ffi.Pointer<wire_uint_8_list>)>();

  ffi.Pointer<wire_uint_8_list> new_uint_8_list_16(
    int len,
  ) {
    return _new_uint_8_list_16(
      len,
    );
  }

  late final _new_uint_8_list_16Ptr = _lookup<
      ffi.NativeFunction<
          ffi.Pointer<wire_uint_8_list> Function(
              ffi.Int32)>>('new_uint_8_list_16');
  late final _new_uint_8_list_16 = _new_uint_8_list_16Ptr
