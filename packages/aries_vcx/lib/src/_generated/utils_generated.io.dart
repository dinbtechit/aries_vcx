...
class UtilsPlatform extends FlutterRustBridgeBase<UtilsWire> {
  UtilsPlatform(ffi.DynamicLibrary dylib) : super(UtilsWire(dylib));

// Section: api2wire

  @protected
  ffi.Pointer<ffi.Bool> api2wire_box_autoadd_bool(bool raw) {
    return inner.new_box_autoadd_bool_17(api2wire_bool(raw));
  }
...
class UtilsWire implements FlutterRustBridgeWireBase {
  @internal
  ...
  UtilsWire(ffi.DynamicLibrary dynamicLibrary)
      : _lookup = dynamicLibrary.lookup;

  /// The symbols are looked up with [lookup].
  UtilsWire.fromLookup(
  ...
  ffi.Pointer<ffi.Bool> new_box_autoadd_bool_17(
    bool value,
  ) {
    return _new_box_autoadd_bool_17(
      value,
    );
  }

  late final _new_box_autoadd_bool_17Ptr =
      _lookup<ffi.NativeFunction<ffi.Pointer<ffi.Bool> Function(ffi.Bool)>>(
          'new_box_autoadd_bool_17');
  late final _new_box_autoadd_bool_17 = _new_box_autoadd_bool_17Ptr
