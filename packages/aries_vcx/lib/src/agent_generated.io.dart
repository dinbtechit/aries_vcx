...
class AgentFFIPlatform extends FlutterRustBridgeBase<AgentFFIWire> {
  AgentFFIPlatform(ffi.DynamicLibrary dylib) : super(AgentFFIWire(dylib));
...
class AgentFFIWire implements FlutterRustBridgeWireBase {
  @internal
  ...
  AgentFFIWire(ffi.DynamicLibrary dynamicLibrary)
      : _lookup = dynamicLibrary.lookup;

  /// The symbols are looked up with [lookup].
  AgentFFIWire.fromLookup(
  ...
  void wire_generate_public_invitation(
    ...
    return _wire_generate_public_invitation(
      port_,
      public_did,
      label,
    );
  ...
  late final _wire_generate_public_invitationPtr = _lookup<
          ffi.NativeFunction<
              ffi.Void Function(ffi.Int64, ffi.Pointer<wire_uint_8_list>,
                  ffi.Pointer<wire_uint_8_list>)>>(
      'wire_generate_public_invitation');
  late final _wire_generate_public_invitation =
      _wire_generate_public_invitationPtr.asFunction<
