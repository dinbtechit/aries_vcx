...
class AriesVcxPlatform extends FlutterRustBridgeBase<AriesVcxWire> {
  AriesVcxPlatform(ffi.DynamicLibrary dylib) : super(AriesVcxWire(dylib));
...
class AriesVcxWire implements FlutterRustBridgeWireBase {
  @internal
  ...
  AriesVcxWire(ffi.DynamicLibrary dynamicLibrary)
      : _lookup = dynamicLibrary.lookup;

  /// The symbols are looked up with [lookup].
  AriesVcxWire.fromLookup(
