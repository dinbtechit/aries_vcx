...
class CredentialDefinitionFFIPlatform
  ...
  CredentialDefinitionFFIPlatform(ffi.DynamicLibrary dylib)
...
class CredentialDefinitionFFIWire implements FlutterRustBridgeWireBase {
  @internal
  ...
  CredentialDefinitionFFIWire(ffi.DynamicLibrary dynamicLibrary)
      : _lookup = dynamicLibrary.lookup;

  /// The symbols are looked up with [lookup].
  CredentialDefinitionFFIWire.fromLookup(
