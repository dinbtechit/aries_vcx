...
class LedgerPlatform extends FlutterRustBridgeBase<LedgerWire> {
  LedgerPlatform(ffi.DynamicLibrary dylib) : super(LedgerWire(dylib));
...
// Section: api2wire
  ...
  ffi.Pointer<wire_StringList> api2wire_StringList(List<String> raw) {
    final ans = inner.new_StringList_5(raw.length);
...
class LedgerWire implements FlutterRustBridgeWireBase {
  @internal
  ...
  LedgerWire(ffi.DynamicLibrary dynamicLibrary)
      : _lookup = dynamicLibrary.lookup;

  /// The symbols are looked up with [lookup].
  LedgerWire.fromLookup(
  ...
  ffi.Pointer<wire_StringList> new_StringList_5(
    int len,
  ) {
    return _new_StringList_5(
      len,
    );
  }

  late final _new_StringList_5Ptr = _lookup<
          ffi.NativeFunction<ffi.Pointer<wire_StringList> Function(ffi.Int32)>>(
      'new_StringList_5');
  late final _new_StringList_5 = _new_StringList_5Ptr
