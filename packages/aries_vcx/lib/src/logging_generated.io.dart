...
class LoggingPlatform extends FlutterRustBridgeBase<LoggingWire> {
  LoggingPlatform(ffi.DynamicLibrary dylib) : super(LoggingWire(dylib));
...
class LoggingWire implements FlutterRustBridgeWireBase {
  @internal
  ...
  LoggingWire(ffi.DynamicLibrary dynamicLibrary)
      : _lookup = dynamicLibrary.lookup;

  /// The symbols are looked up with [lookup].
  LoggingWire.fromLookup(
