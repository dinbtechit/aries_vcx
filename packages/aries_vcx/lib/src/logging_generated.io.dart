...
class LoggingFFIPlatform extends FlutterRustBridgeBase<LoggingFFIWire> {
  LoggingFFIPlatform(ffi.DynamicLibrary dylib) : super(LoggingFFIWire(dylib));
...
class LoggingFFIWire implements FlutterRustBridgeWireBase {
  @internal
  ...
  LoggingFFIWire(ffi.DynamicLibrary dynamicLibrary)
      : _lookup = dynamicLibrary.lookup;

  /// The symbols are looked up with [lookup].
  LoggingFFIWire.fromLookup(
  ...
  void wire_init_default_logger(
    int port_,
    ffi.Pointer<wire_uint_8_list> pattern,
  ) {
    return _wire_init_default_logger(
      port_,
      pattern,
    );
  }

  late final _wire_init_default_loggerPtr = _lookup<
      ffi.NativeFunction<
          ffi.Void Function(ffi.Int64,
              ffi.Pointer<wire_uint_8_list>)>>('wire_init_default_logger');
  late final _wire_init_default_logger = _wire_init_default_loggerPtr
