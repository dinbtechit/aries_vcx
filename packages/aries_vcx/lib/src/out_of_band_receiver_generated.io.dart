...
class OutOfBandReceiverPlatform
  ...
  OutOfBandReceiverPlatform(ffi.DynamicLibrary dylib)
...
class OutOfBandReceiverWire implements FlutterRustBridgeWireBase {
  @internal
  ...
  OutOfBandReceiverWire(ffi.DynamicLibrary dynamicLibrary)
      : _lookup = dynamicLibrary.lookup;

  /// The symbols are looked up with [lookup].
  OutOfBandReceiverWire.fromLookup(
  ...
  void wire_out_of_band_receiver_create(
    int port_,
    ffi.Pointer<wire_uint_8_list> msg,
  ) {
    return _wire_out_of_band_receiver_create(
      port_,
      msg,
    );
  }

  late final _wire_out_of_band_receiver_createPtr = _lookup<
          ffi.NativeFunction<
              ffi.Void Function(ffi.Int64, ffi.Pointer<wire_uint_8_list>)>>(
      'wire_out_of_band_receiver_create');
  late final _wire_out_of_band_receiver_create =
      _wire_out_of_band_receiver_createPtr
  ...
  void wire_out_of_band_receiver_extract_message(
    ...
    return _wire_out_of_band_receiver_extract_message(
      port_,
      handle,
    );
  }

  late final _wire_out_of_band_receiver_extract_messagePtr =
      _lookup<ffi.NativeFunction<ffi.Void Function(ffi.Int64, ffi.Uint32)>>(
          'wire_out_of_band_receiver_extract_message');
  late final _wire_out_of_band_receiver_extract_message =
      _wire_out_of_band_receiver_extract_messagePtr
