...
class OutOfBandSenderFFIPlatform
  ...
  OutOfBandSenderFFIPlatform(ffi.DynamicLibrary dylib)
...
class OutOfBandSenderFFIWire implements FlutterRustBridgeWireBase {
  @internal
  ...
  OutOfBandSenderFFIWire(ffi.DynamicLibrary dynamicLibrary)
      : _lookup = dynamicLibrary.lookup;

  /// The symbols are looked up with [lookup].
  OutOfBandSenderFFIWire.fromLookup(
