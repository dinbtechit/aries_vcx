...
class ProofFFIPlatform extends FlutterRustBridgeBase<ProofFFIWire> {
  ProofFFIPlatform(ffi.DynamicLibrary dylib) : super(ProofFFIWire(dylib));
...
class ProofFFIWire implements FlutterRustBridgeWireBase {
  @internal
  ...
  ProofFFIWire(ffi.DynamicLibrary dynamicLibrary)
      : _lookup = dynamicLibrary.lookup;

  /// The symbols are looked up with [lookup].
  ProofFFIWire.fromLookup(
