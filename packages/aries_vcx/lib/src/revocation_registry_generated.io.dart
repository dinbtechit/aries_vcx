...
class RevocationRegistryFFIPlatform
  ...
  RevocationRegistryFFIPlatform(ffi.DynamicLibrary dylib)
...
class RevocationRegistryFFIWire implements FlutterRustBridgeWireBase {
  @internal
  ...
  RevocationRegistryFFIWire(ffi.DynamicLibrary dynamicLibrary)
      : _lookup = dynamicLibrary.lookup;

  /// The symbols are looked up with [lookup].
  RevocationRegistryFFIWire.fromLookup(
