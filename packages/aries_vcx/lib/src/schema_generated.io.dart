...
class SchemaFFIPlatform extends FlutterRustBridgeBase<SchemaFFIWire> {
  SchemaFFIPlatform(ffi.DynamicLibrary dylib) : super(SchemaFFIWire(dylib));
...
class SchemaFFIWire implements FlutterRustBridgeWireBase {
  @internal
  ...
  SchemaFFIWire(ffi.DynamicLibrary dynamicLibrary)
      : _lookup = dynamicLibrary.lookup;

  /// The symbols are looked up with [lookup].
  SchemaFFIWire.fromLookup(
