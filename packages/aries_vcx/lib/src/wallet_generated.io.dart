...
class WalletFFIPlatform extends FlutterRustBridgeBase<WalletFFIWire> {
  WalletFFIPlatform(ffi.DynamicLibrary dylib) : super(WalletFFIWire(dylib));
...
// Section: api2wire
  ...
  ffi.Pointer<wire_IssuerConfig> api2wire_box_autoadd_issuer_config(
      IssuerConfig raw) {
    final ptr = inner.new_box_autoadd_issuer_config_16();
  ...
  ffi.Pointer<wire_RestoreWalletConfigs>
    ...
    final ptr = inner.new_box_autoadd_restore_wallet_configs_16();
  ...
  ffi.Pointer<wire_WalletConfig> api2wire_box_autoadd_wallet_config(
      WalletConfig raw) {
    final ptr = inner.new_box_autoadd_wallet_config_16();
...
class WalletFFIWire implements FlutterRustBridgeWireBase {
  @internal
  ...
  WalletFFIWire(ffi.DynamicLibrary dynamicLibrary)
      : _lookup = dynamicLibrary.lookup;

  /// The symbols are looked up with [lookup].
  WalletFFIWire.fromLookup(
