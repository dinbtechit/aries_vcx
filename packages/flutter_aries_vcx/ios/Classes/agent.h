...
void wire_generate_public_invitation(int64_t port_,
...
static int64_t dummy_method_to_enforce_bundling_Agent(void) {
    int64_t dummy_var = 0;
    dummy_var ^= ((int64_t) (void*) wire_generate_public_invitation);
