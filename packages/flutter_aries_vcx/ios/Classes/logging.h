...
void wire_init_default_logger(int64_t port_, struct wire_uint_8_list *pattern);
...
static int64_t dummy_method_to_enforce_bundling_Logging(void) {
    int64_t dummy_var = 0;
    dummy_var ^= ((int64_t) (void*) wire_init_default_logger);
