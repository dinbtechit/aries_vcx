...
void wire_open_main_pool(int64_t port_, struct wire_PoolConfig *pool_config);

void wire_close_main_pool(int64_t port_);
...
static int64_t dummy_method_to_enforce_bundling_Pool(void) {
    int64_t dummy_var = 0;
    dummy_var ^= ((int64_t) (void*) wire_open_main_pool);
    dummy_var ^= ((int64_t) (void*) wire_close_main_pool);
    dummy_var ^= ((int64_t) (void*) new_box_autoadd_pool_config_11);
