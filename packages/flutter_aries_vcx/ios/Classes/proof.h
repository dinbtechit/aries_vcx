...
void wire_proof_create(int64_t port_,
                       struct wire_uint_8_list *source_id,
                       struct wire_uint_8_list *requested_attrs,
                       struct wire_uint_8_list *requested_predicates,
                       struct wire_uint_8_list *revocation_details,
                       struct wire_uint_8_list *name);

void wire_proof_get_proof_msg(int64_t port_, uint32_t handle);

void wire_proof_release(int64_t port_, uint32_t handle);

void wire_proof_send_request(int64_t port_, uint32_t handle_proof, uint32_t handle_connection);

void wire_proof_get_request_msg(int64_t port_, uint32_t handle);

void wire_proof_serialize(int64_t port_, uint32_t handle);

void wire_proof_deserialize(int64_t port_, struct wire_uint_8_list *data);

void wire_v2_proof_update_state(int64_t port_, uint32_t handle_proof, uint32_t connection_handle);

void wire_v2_proof_update_state_with_message(int64_t port_,
                                             uint32_t handle_proof,
                                             struct wire_uint_8_list *message,
                                             uint32_t connection_handle);

void wire_proof_get_state(int64_t port_, uint32_t handle);

void wire_proof_get_proof_state(int64_t port_, uint32_t handle);

void wire_proof_get_thread_id(int64_t port_, uint32_t handle);

void wire_mark_presentation_request_msg_sent(int64_t port_, uint32_t handle);

struct wire_uint_8_list *new_uint_8_list_12(int32_t len);
...
static int64_t dummy_method_to_enforce_bundling_Proof(void) {
    int64_t dummy_var = 0;
    dummy_var ^= ((int64_t) (void*) wire_proof_create);
    dummy_var ^= ((int64_t) (void*) wire_proof_get_proof_msg);
    dummy_var ^= ((int64_t) (void*) wire_proof_release);
    dummy_var ^= ((int64_t) (void*) wire_proof_send_request);
    dummy_var ^= ((int64_t) (void*) wire_proof_get_request_msg);
    dummy_var ^= ((int64_t) (void*) wire_proof_serialize);
    dummy_var ^= ((int64_t) (void*) wire_proof_deserialize);
    dummy_var ^= ((int64_t) (void*) wire_v2_proof_update_state);
    dummy_var ^= ((int64_t) (void*) wire_v2_proof_update_state_with_message);
    dummy_var ^= ((int64_t) (void*) wire_proof_get_state);
    dummy_var ^= ((int64_t) (void*) wire_proof_get_proof_state);
    dummy_var ^= ((int64_t) (void*) wire_proof_get_thread_id);
    dummy_var ^= ((int64_t) (void*) wire_mark_presentation_request_msg_sent);
    dummy_var ^= ((int64_t) (void*) new_uint_8_list_12);
