...
void wire_schema_get_attributes(int64_t port_,
                                struct wire_uint_8_list *_source_id,
                                struct wire_uint_8_list *_schema_id);

void wire_schema_prepare_for_endorser(int64_t port_);

void wire_schema_create(int64_t port_,
                        struct wire_uint_8_list *source_id,
                        struct wire_uint_8_list *name,
                        struct wire_uint_8_list *version,
                        struct wire_uint_8_list *data);

void wire_schema_get_schema_id(int64_t port_, uint32_t handle_schema);

void wire_schema_deserialize(int64_t port_, struct wire_uint_8_list *serialized);

void wire_schema_serialize(int64_t port_, uint32_t handle_schema);

void wire_schema_release(int64_t port_, uint32_t handle_schema);

void wire_schema_update_state(int64_t port_, uint32_t handle_schema);

void wire_schema_get_state(int64_t port_, uint32_t handle_schema);

struct wire_uint_8_list *new_uint_8_list_14(int32_t len);
...
static int64_t dummy_method_to_enforce_bundling_Schema(void) {
    int64_t dummy_var = 0;
    dummy_var ^= ((int64_t) (void*) wire_schema_get_attributes);
    dummy_var ^= ((int64_t) (void*) wire_schema_prepare_for_endorser);
    dummy_var ^= ((int64_t) (void*) wire_schema_create);
    dummy_var ^= ((int64_t) (void*) wire_schema_get_schema_id);
    dummy_var ^= ((int64_t) (void*) wire_schema_deserialize);
    dummy_var ^= ((int64_t) (void*) wire_schema_serialize);
    dummy_var ^= ((int64_t) (void*) wire_schema_release);
    dummy_var ^= ((int64_t) (void*) wire_schema_update_state);
    dummy_var ^= ((int64_t) (void*) wire_schema_get_state);
    dummy_var ^= ((int64_t) (void*) new_uint_8_list_14);
