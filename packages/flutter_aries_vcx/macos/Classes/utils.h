...
void wire_shutdown(int64_t port_, bool *delete_all);

void wire_get_version(int64_t port_);

bool *new_box_autoadd_bool_17(bool value);
...
static int64_t dummy_method_to_enforce_bundling_Utils(void) {
    int64_t dummy_var = 0;
    dummy_var ^= ((int64_t) (void*) wire_shutdown);
    dummy_var ^= ((int64_t) (void*) wire_get_version);
    dummy_var ^= ((int64_t) (void*) new_box_autoadd_bool_17);
